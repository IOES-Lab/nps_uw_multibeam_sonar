...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_nps_uw_multibeam_sonar = get_package_share_directory("nps_uw_multibeam_sonar")
    ...
    world_path = os.path.join(pkg_nps_uw_multibeam_sonar, "worlds", world_file_name)
